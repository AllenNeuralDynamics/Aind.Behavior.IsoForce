...
async def iso_force_experiment(launcher: Launcher) -> None:
    ...
    if picker.frontend.prompt_confirm(
        ...
        try:
            ...
            from aind_behavior_iso_force.data_qc import make_qc_runner

            iso_force_dataset = data_contract.dataset(launcher.session_directory)
...
def ensure_rig_and_computer_name(rig: AindIsoForceRig) -> None:

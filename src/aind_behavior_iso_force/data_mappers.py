...
class AindSessionDataMapper(ads.AindDataSchemaSessionDataMapper):
    def __init__(
        ...
        rig_model: AindIsoForceRig,
        task_logic_model: AindIsoForceTaskLogic,
...
def aind_rig_data_mapper_factory(
    launcher: BehaviorLauncher[AindIsoForceRig, AindBehaviorSessionModel, AindIsoForceTaskLogic],
) -> AindRigDataMapper:
    rig_schema: AindIsoForceRig = launcher.rig_schema

...
class TestAindSessionDataMapper(unittest.TestCase):
    ...
    @patch("aind_behavior_iso_force.data_mappers.AindSessionDataMapper._map")
    ...
    # todo disable until https://github.com/AllenNeuralDynamics/aind-data-schema/pull/1269 is merged
    # def test_map(self):
...
class TestAindRigDataMapper(unittest.TestCase):
    ...
    @patch("aind_behavior_iso_force.data_mappers.model_from_json_file")
